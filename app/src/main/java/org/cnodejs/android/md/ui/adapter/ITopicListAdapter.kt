...
abstract class ITopicListAdapter<Topic : ITopic, VH : ITopicListAdapter.ViewHolder>(diffCallback: DiffUtil.ItemCallback<Topic>) : ListAdapter<Topic, VH>(diffCallback) {
